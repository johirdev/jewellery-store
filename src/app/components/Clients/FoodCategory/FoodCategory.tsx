...
const CIRCLE_SIZE =
  "h-[180px] w-[140px] sm:h-[180px] sm:w-[140px] md:h-[400px] md:w-[130px] lg:h-[400px] lg:w-[300px]";
        ...
        >
          {categories.map((category) => {
            ...
            return (
              <Link
                key={category._id}
                href={`/jewellery?category_id=${category._id}`}
              ...
              >
                <span
                  className={`relative flex ${CIRCLE_SIZE} aspect-square shrink-0 items-center justify-center overflow-hidden rounded-sm bg-gradient-to-br from-sky-50 to-sky-100 shadow-[0_6px_16px_rgba(0,0,0,0.08)] transition-all duration-200 group-hover:-translate-y-1 group-hover:shadow-[0_10px_22px_rgba(0,0,0,0.14)] ${
                    active
